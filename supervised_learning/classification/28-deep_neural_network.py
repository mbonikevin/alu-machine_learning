#!/usr/bin/env python3
"""deep neural network with a choice of activation in the hidden layers"""
...
class DeepNeuralNetwork:
    """deep net, sigmoid or tanh for hidden layers, softmax for output"""

    def __init__(self, nx, layers, activation='sig'):
        """build the network and remember which hidden activation to use"""
    ...
    def forward_prop(self, X):
        """forward pass with chosen hidden activation and softmax output"""
        self.__cache['A0'] = X
